...
{
    // =========================================================
    // FUNZIONALITA' DISABILITATA - show_checkrawtx
    // La serializzazione di unsigned_tx_set e signed_tx_set
    // non e' compatibile con questa versione di mevacoin.
    // =========================================================
    (void)raw_tx_data;
    (void)action;
    return string("Funzionalita' 'Check Raw Transaction' disabilitata: "
                  "serializzazione wallet2 incompatibile con questa versione di mevacoin.");
}
...
{
    // =========================================================
    // FUNZIONALITA' DISABILITATA - show_pushrawtx
    // La serializzazione di signed_tx_set
    // non e' compatibile con questa versione di mevacoin.
    // =========================================================
    (void)raw_tx_data;
    (void)action;
    return string("Funzionalita' 'Push Raw Transaction' disabilitata: "
                  "serializzazione wallet2 incompatibile con questa versione di mevacoin.");
}
...
json_version()
{
    ...
    j_data = json {
            ...
            {"monero_version_full" , string {MEVACOIN_VERSION_FULL}},
